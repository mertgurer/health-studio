...
function About() {
    ...
    return (
        <section
            id="about"
            className="flex flex-col items-center justify-center bg-secondary py-[10vh] gap-[12vh] max-md:gap-[2vh] max-md:py-[5vh]"
        >
            <div className="relative flex items-center justify-center gap-10 px-[5%] max-2xl:px-0">
                <div className="flex flex-col rounded-sm py-10 px-12 gap-3 z-10 w-1/2 max-2xl:w-2/3 max-md:w-[90%] max-md:px-2">
