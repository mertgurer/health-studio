  ...
  return (
    ...
    >
      <div className="flex flex-col justify-center items-center">
        <h1 className="max-2xl:text-sm">- {t("Services.subtitle")} -</h1>
      ...
      <div className="flex items-center justify-center w-full">
        {!isMobile && (
          ...
          >
            <HugeiconsIcon icon={ArrowLeft01Icon} size={36} strokeWidth={1.5} />
          </button>
        )}
              ...
              .map((service, index) => (
                <ServiceFrames
                  ...
                  data={{
                    ...
                    icon: ServiceData[service.id].icon,
                  }}
                  image={ServiceData[service.id].image}
                  index={index}
                  inverse={index % 2 === 1}
