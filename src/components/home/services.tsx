...
function Services() {
    ...
    return (
        <section
            id="services"
            className="flex flex-col items-center justify-center gap-16 pt-[6%] pb-16 max-2xl:pb-0 max-md:gap-8 max-md:pt-[8vh] max-md:pb-[4vh]"
        >
                        ...
                        >
                            <div className="flex flex-col items-start gap-3">
                                <div className="flex text-3xl font-semibold italic gap-3 ml-2 max-md:text-2xl max-md:items-center">
                                    ...
                                    />
                                    <span>{t(selectedService.title)}</span>
                                </div>
